...
A Promise in JavaScript is an object that represents the eventual completion (or failure) of an asynchronous operation. It allows you to handle asynchronous tasks like fetching data, reading files, or making API calls without using callbacks (which can lead to "callback hell").
...
# JavaScript Promises - Interview Q&A Guide

#### 1. What is a Promise in JavaScript?

A Promise in JavaScript is an object that represents the eventual completion (or failure) of an asynchronous operation. It helps handle asynchronous operations in a more readable and structured way than traditional callbacks.
...
| Method                 | Behavior                                                                                            |
| ---------------------- | --------------------------------------------------------------------------------------------------- |
| `Promise.all()`        | Waits for all promises to resolve. If any fails, it rejects immediately                             |
| `Promise.allSettled()` | Waits for all promises to settle (either resolved or rejected), returning an array with each result |
...
| Method           | Behavior                                                                             |
| ---------------- | ------------------------------------------------------------------------------------ |
| `Promise.race()` | Returns the first promise to settle (either resolved or rejected)                    |
| `Promise.any()`  | Returns the first successfully resolved promise (ignores rejections unless all fail) |
